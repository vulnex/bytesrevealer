/** * VULNEX -Bytes Revealer- * * File: FormatSelector.vue * Author: Simon Roses Femerling *
Created: 2025-09-27 * Last Modified: 2025-09-27 * Version: 0.4 * License: Apache-2.0 * Copyright (c)
...
<template>
  <div class="format-selector">
    <div class="selector-header">
      ...
      <div class="selector-controls">
        <div class="button-group">
          ...
          <button class="reset-btn" title="Clear selected format" @click="clearFormat">↺</button>
        </div>
      </div>
    </div>
    ...
    <div v-if="currentFormat" class="format-info">
      ...
      <span v-if="isAutoDetected" class="format-badge auto"> Auto-detected </span>
    ...
    <div v-if="showUploader" class="modal-overlay" @click="showUploader = false">
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-body">
          <KsyUploader @formats-loaded="handleFormatsLoaded" @error="handleError" />
        </div>
      </div>
    </div>
    ...
    <div v-if="showLibrary" class="modal-overlay" @click="showLibrary = false">
      <div class="modal-content large" @click.stop>
        ...
        <div class="modal-body">
          <KsyLibrary @format-use="handleFormatUse" @format-edit="handleFormatEdit" />
        </div>
      </div>
    </div>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const loadFormats = async (_skipDetection = false) => {
      try {
