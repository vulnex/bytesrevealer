/** * VULNEX -Bytes Revealer- * * File: ProgressTracking.vue * Author: Simon Roses Femerling *
...
<template>
  <div class="progress-tracking space-y-2">
    ...
    <div v-for="type in activeAnalyses" :key="type" class="analysis-progress">
...
const totalProgress = computed(() => {
  ...
  const sum = activeAnalyses.value.reduce((acc, key) => acc + props.progress[key], 0)
