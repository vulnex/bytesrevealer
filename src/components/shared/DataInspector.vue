/** * VULNEX -Bytes Revealer- * * File: DataInspector.vue * Author: Simon Roses Femerling * Created:
...
<template>
  <div class="data-inspector" :class="{ 'is-locked': isLocked }">
    <div class="inspector-header">
      ...
      <span v-if="isLocked" class="lock-status">[Locked]</span>
    ...
    <div class="inspector-content">
      ...
      <div class="inspector-group">
        ...
        <div v-show="groupStates.bases" class="group-content">
          <div class="group-item">
            <label>Decimal:</label>
            <span>{{ value }}</span>
          </div>
      ...
      <div class="inspector-group">
        ...
        <div v-show="groupStates.text" class="group-content">
          <div class="group-item">
            <label>ASCII:</label>
      ...
      <div class="inspector-group">
        ...
        <div v-show="groupStates['16bit']" class="group-content">
          <div class="group-item">
      ...
      <div class="inspector-group">
        ...
        <div v-show="groupStates['32bit']" class="group-content">
          <div class="group-item">
      ...
      <div class="inspector-group">
        ...
        <div v-show="groupStates['64bit']" class="group-content">
          <div class="group-item">
      ...
      <div class="inspector-group">
        ...
        <div v-show="groupStates.integers" class="group-content">
          <div class="group-item">
      ...
      <div class="inspector-group">
        ...
        <div v-show="groupStates.floats" class="group-content">
          <div class="group-item">
      ...
      <div class="inspector-group">
        ...
        <div v-show="groupStates.additional" class="group-content">
          <div class="group-item">
      ...
      <div class="inspector-group">
        ...
        <div v-show="groupStates.datetime" class="group-content">
          <div class="group-item">
